...
sed -i "s/Exec=sway/Exec=QT_QPA_PLATFORM=wayland QT_QPA_PLATFORMTHEME=qt6ct QT_STYLE_OVERRIDE=kvantum GTK_THEME=Catppuccin-Mocha-Standard-Flamingo-Dark sway/g" ./sway.desktop
